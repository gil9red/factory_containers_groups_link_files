...
# TODO: перемещение иконок
# TODO: оохранение ярлыков как файлов (сами файлы сохранять, думаю не стоит -- могут много весить)
# TODO: иконку можно сгенерировать на основе иконок добавленных ярлыков
# TODO: если файл при добавлении в список проги (например из STATIC_CONFIG.py) оказался
# отсутствующим, то все равно добавить, но пометить его как нибудь. Если есть его иконка,
# можно на нее что нибудь пририсовать и в toolTip добавить об этом что нибудь, или фон элемента
# поменять
# TODO: файл запускать из его папки -- возможно ему нужны в своей папке какие-то файлы
# а при текущем вызове они будут искаться, скорее всего, там где скрипт (см пример
# проги хранения списка файлов там вроде бы это было исправлено)
